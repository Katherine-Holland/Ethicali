# backend/validator/eu_ai_act/eu_agent_node.py
import json
from backend.validator.agent_validator import run_agent_validation
...
def validate_agent(conversation_input):
    ...
    return {
        ...
        "overall_compliance": "Yes" if overall_pass else base_results["overall_compliance"],
